  ...
  return (
    <>
      <div className="dash-card flex flex-col gap-3 sm:gap-4 group">
        ...
        <h3 className="font-display text-sm sm:text-base font-semibold leading-snug">{description ? title : title}</h3>
        ...
        >
          {t("Launch Tool", "Iniciar herramienta")} <ArrowRight className="ml-1.5 h-3.5 w-3.5" />
        </Button>
      </div>
